...
func init() {
	proto.RegisterType((*HelloRequest)(nil), "naturae.HelloRequest")
	proto.RegisterType((*HelloReply)(nil), "naturae.HelloReply")
}
...
var fileDescriptor_7ed94b0a22d11796 = []byte{
	...
	0xd3, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0xcf, 0x4b, 0x2c, 0x29, 0x2d, 0x4a, 0x4c, 0x55,
	...
	0x8b, 0x13, 0xd3, 0x61, 0x8a, 0x60, 0x5c, 0xa3, 0x26, 0x46, 0x2e, 0x76, 0xf7, 0xa2, 0xd4, 0xd4,
	0x92, 0xd4, 0x22, 0x21, 0x0b, 0x2e, 0x8e, 0xe0, 0xc4, 0x4a, 0xb0, 0x36, 0x21, 0x51, 0x3d, 0xa8,
	0x6d, 0x7a, 0xc8, 0x56, 0x49, 0x09, 0xa3, 0x0b, 0x17, 0xe4, 0x54, 0x2a, 0x31, 0x08, 0xd9, 0x72,
	0xf1, 0xc2, 0x74, 0x3a, 0xa6, 0x27, 0x66, 0xe6, 0x91, 0xa6, 0x3d, 0x89, 0x0d, 0xec, 0x41, 0x63,
	0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0xc6, 0xd8, 0x41, 0x55, 0xee, 0x00, 0x00, 0x00,
}
...
func (c *greeterClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/naturae.Greeter/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greeterClient) SayHelloAgain(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/naturae.Greeter/SayHelloAgain", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greeter_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/naturae.Greeter/SayHello",
	}
...
func _Greeter_SayHelloAgain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/naturae.Greeter/SayHelloAgain",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
